<# ============================================================
   deploy-project-buttons-bottom.ps1
   Fixes: Live Site / Repository buttons now always sit at the bottom
   of each project card (aligned across all cards regardless of
   description length), and "LIVE SITE" no longer wraps to two lines.

   Writes (with backups of any existing files):
     sources/UI/components/panels/AboutPanel.vue   (modified: layout + button sizing fix)
   ...
   USAGE:
     ...
     2. Save this file as deploy-project-buttons-bottom.ps1
     3. Run:
          Unblock-File .\deploy-project-buttons-bottom.ps1
          powershell -ExecutionPolicy Bypass -File .\deploy-project-buttons-bottom.ps1
   ============================================================ #>
...
Write-Host "  npm run dev   # check About Me > Projects: buttons should sit at the same bottom line on all 3 cards, text on one line"
