...
`)+`
`+u);const E=b+d+o,y=b+u+s,B=Ts(n,n.VERTEX_SHADER,E),R=Ts(n,n.FRAGMENT_SHADER,y);n.attachShader(M,B),n.attachShader(M,R),t.index0AttributeName!==void 0?n.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(M,0,"position"),n.linkProgram(M);function w(P){if(r.debug.checkShaderErrors){const H=n.getProgramInfoLog(M).trim(),z=n.getShaderInfoLog(B).trim(),X=n.getShaderInfoLog(R).trim();let Y=!0,k=!0;if(n.getProgramParameter(M,n.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(n,M,B,R);else{const Z=ys(n,B,"vertex"),V=ys(n,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(M,n.VALIDATE_STATUS)+`
...
}`;function fp(r,e,t){let i=new lo;const n=new Be,a=new Be,o=new ot,s=new up({depthPacking:sl}),l=new hp,c={},h=t.maxTextureSize,f={[si]:mt,[mt]:si,[Xt]:Xt},p=new Kt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Be},radius:{value:4}},vertexShader:dp,fragmentShader:pp}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const x=new Ai;x.setAttribute("position",new Ot(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Nt(x,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Os;let u=this.type;this.render=function(R,w,F){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||R.length===0)return;const S=r.getRenderTarget(),v=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),H=r.state;H.setBlending(ni),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const z=u!==Wt&&this.type===Wt,X=u===Wt&&this.type!==Wt;for(let Y=0,k=R.length;Y<k;Y++){const Z=R[Y],V=Z.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;n.copy(V.mapSize);const ne=V.getFrameExtents();if(n.multiply(ne),a.copy(V.mapSize),(n.x>h||n.y>h)&&(n.x>h&&(a.x=Math.floor(h/ne.x),n.x=a.x*ne.x,V.mapSize.x=a.x),n.y>h&&(a.y=Math.floor(h/ne.y),n.y=a.y*ne.y,V.mapSize.y=a.y)),V.map===null||z===!0||X===!0){const Me=this.type!==Wt?{minFilter:yt,magFilter:yt}:{};V.map!==null&&V.map.dispose(),V.map=new yi(n.x,n.y,Me),V.map.texture.name=Z.name+".shadowMap",V.camera.updateProjectionMatrix()}r.setRenderTarget(V.map),r.clear();const me=V.getViewportCount();for(let Me=0;Me<me;Me++){const De=V.getViewport(Me);o.set(a.x*De.x,a.y*De.y,a.x*De.z,a.y*De.w),H.viewport(o),V.updateMatrices(Z,Me),i=V.getFrustum(),y(w,F,V.camera,Z,this.type)}V.isPointLightShadow!==!0&&this.type===Wt&&b(V,F),V.needsUpdate=!1}u=this.type,d.needsUpdate=!1,r.setRenderTarget(S,v,P)};function b(R,w){const F=e.update(M);p.defines.VSM_SAMPLES!==R.blurSamples&&(p.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new yi(n.x,n.y)),p.uniforms.shadow_pass.value=R.map.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,r.setRenderTarget(R.mapPass),r.clear(),r.renderBufferDirect(w,null,F,p,M,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,r.setRenderTarget(R.map),r.clear(),r.renderBufferDirect(w,null,F,m,M,null)}function E(R,w,F,S){let v=null;const P=F.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)v=P;else if(v=F.isPointLight===!0?l:s,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const H=v.uuid,z=w.uuid;let X=c[H];X===void 0&&(X={},c[H]=X);let Y=X[z];Y===void 0&&(Y=v.clone(),X[z]=Y,w.addEventListener("dispose",B)),v=Y}if(v.visible=w.visible,v.wireframe=w.wireframe,S===Wt?v.side=w.shadowSide!==null?w.shadowSide:w.side:v.side=w.shadowSide!==null?w.shadowSide:f[w.side],v.alphaMap=w.alphaMap,v.alphaTest=w.alphaTest,v.map=w.map,v.clipShadows=w.clipShadows,v.clippingPlanes=w.clippingPlanes,v.clipIntersection=w.clipIntersection,v.displacementMap=w.displacementMap,v.displacementScale=w.displacementScale,v.displacementBias=w.displacementBias,v.wireframeLinewidth=w.wireframeLinewidth,v.linewidth=w.linewidth,F.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const H=r.properties.get(v);H.light=F}return v}function y(R,w,F,S,v){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&v===Wt)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,R.matrixWorld);const H=e.update(R),z=R.material;if(Array.isArray(z)){const X=H.groups;for(let Y=0,k=X.length;Y<k;Y++){const Z=X[Y],V=z[Z.materialIndex];if(V&&V.visible){const ne=E(R,V,S,v);R.onBeforeShadow(r,R,w,F,H,ne,Z),r.renderBufferDirect(F,null,H,ne,R,Z),R.onAfterShadow(r,R,w,F,H,ne,Z)}}}else if(z.visible){const X=E(R,z,S,v);R.onBeforeShadow(r,R,w,F,H,X,null),r.renderBufferDirect(F,null,H,X,R,null),R.onAfterShadow(r,R,w,F,H,X,null)}}const P=R.children;for(let H=0,z=P.length;H<z;H++)y(P[H],w,F,S,v)}function B(R){R.target.removeEventListener("dispose",B);for(const w in c){const F=c[w],S=R.target.uuid;S in F&&(F[S].dispose(),delete F[S])}}}function mp(r){function e(){let C=!1;const te=new ot;let W=null;const q=new ot(0,0,0,0);return{setMask:function(ie){W!==ie&&!C&&(r.colorMask(ie,ie,ie,ie),W=ie)},setLocked:function(ie){C=ie},setClear:function(ie,_e,We,$e,lt){lt===!0&&(ie*=$e,_e*=$e,We*=$e),te.set(ie,_e,We,$e),q.equals(te)===!1&&(r.clearColor(ie,_e,We,$e),q.copy(te))},reset:function(){C=!1,W=null,q.set(-1,0,0,0)}}}function t(){let C=!1,te=null,W=null,q=null;return{setTest:function(ie){ie?he(r.DEPTH_TEST):oe(r.DEPTH_TEST)},setMask:function(ie){te!==ie&&!C&&(r.depthMask(ie),te=ie)},setFunc:function(ie){if(W!==ie){switch(ie){case ko:r.depthFunc(r.NEVER);break;case Go:r.depthFunc(r.ALWAYS);break;case Wo:r.depthFunc(r.LESS);break;case jr:r.depthFunc(r.LEQUAL);break;case Xo:r.depthFunc(r.EQUAL);break;case qo:r.depthFunc(r.GEQUAL);break;case jo:r.depthFunc(r.GREATER);break;case Yo:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}W=ie}},setLocked:function(ie){C=ie},setClear:function(ie){q!==ie&&(r.clearDepth(ie),q=ie)},reset:function(){C=!1,te=null,W=null,q=null}}}function i(){let C=!1,te=null,W=null,q=null,ie=null,_e=null,We=null,$e=null,lt=null;return{setTest:function(Fe){C||(Fe?he(r.STENCIL_TEST):oe(r.STENCIL_TEST))},setMask:function(Fe){te!==Fe&&!C&&(r.stencilMask(Fe),te=Fe)},setFunc:function(Fe,Bt,Lt){(W!==Fe||q!==Bt||ie!==Lt)&&(r.stencilFunc(Fe,Bt,Lt),W=Fe,q=Bt,ie=Lt)},setOp:function(Fe,Bt,Lt){(_e!==Fe||We!==Bt||$e!==Lt)&&(r.stencilOp(Fe,Bt,Lt),_e=Fe,We=Bt,$e=Lt)},setLocked:function(Fe){C=Fe},setClear:function(Fe){lt!==Fe&&(r.clearStencil(Fe),lt=Fe)},reset:function(){C=!1,te=null,W=null,q=null,ie=null,_e=null,We=null,$e=null,lt=null}}}const n=new e,a=new t,o=new i,s=new WeakMap,l=new WeakMap;let c={},h={},f=new WeakMap,p=[],m=null,x=!1,M=null,d=null,u=null,b=null,E=null,y=null,B=null,R=new Oe(0,0,0),w=0,F=!1,S=null,v=null,P=null,H=null,z=null;const X=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,k=0;const Z=r.getParameter(r.VERSION);Z.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(Z)[1]),Y=k>=1):Z.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),Y=k>=2);let V=null,ne={};const me=r.getParameter(r.SCISSOR_BOX),Me=r.getParameter(r.VIEWPORT),De=new ot().fromArray(me),ke=new ot().fromArray(Me);function G(C,te,W,q){const ie=new Uint8Array(4),_e=r.createTexture();r.bindTexture(C,_e),r.texParameteri(C,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(C,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let We=0;We<W;We++)C===r.TEXTURE_3D||C===r.TEXTURE_2D_ARRAY?r.texImage3D(te,0,r.RGBA,1,1,q,0,r.RGBA,r.UNSIGNED_BYTE,ie):r.texImage2D(te+We,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ie);return _e}const Q={};Q[r.TEXTURE_2D]=G(r.TEXTURE_2D,r.TEXTURE_2D,1),Q[r.TEXTURE_CUBE_MAP]=G(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[r.TEXTURE_2D_ARRAY]=G(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Q[r.TEXTURE_3D]=G(r.TEXTURE_3D,r.TEXTURE_3D,1,1),n.setClear(0,0,0,1),a.setClear(1),o.setClear(0),he(r.DEPTH_TEST),a.setFunc(jr),Ge(!1),ge(Fa),he(r.CULL_FACE),Ze(ni);function he(C){c[C]!==!0&&(r.enable(C),c[C]=!0)}function oe(C){c[C]!==!1&&(r.disable(C),c[C]=!1)}function Ae(C,te){return h[C]!==te?(r.bindFramebuffer(C,te),h[C]=te,C===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=te),C===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=te),!0):!1}function Le(C,te){let W=p,q=!1;if(C){W=f.get(te),W===void 0&&(W=[],f.set(te,W));const ie=C.textures;if(W.length!==ie.length||W[0]!==r.COLOR_ATTACHMENT0){for(let _e=0,We=ie.length;_e<We;_e++)W[_e]=r.COLOR_ATTACHMENT0+_e;W.length=ie.length,q=!0}}else W[0]!==r.BACK&&(W[0]=r.BACK,q=!0);q&&r.drawBuffers(W)}function Ie(C){return m!==C?(r.useProgram(C),m=C,!0):!1}const Ye={[vi]:r.FUNC_ADD,[bo]:r.FUNC_SUBTRACT,[Ao]:r.FUNC_REVERSE_SUBTRACT};Ye[wo]=r.MIN,Ye[Ro]=r.MAX;const A={[Co]:r.ZERO,[Po]:r.ONE,[Lo]:r.SRC_COLOR,[Fn]:r.SRC_ALPHA,[Fo]:r.SRC_ALPHA_SATURATE,[No]:r.DST_COLOR,[Io]:r.DST_ALPHA,[Uo]:r.ONE_MINUS_SRC_COLOR,[Bn]:r.ONE_MINUS_SRC_ALPHA,[Oo]:r.ONE_MINUS_DST_COLOR,[Do]:r.ONE_MINUS_DST_ALPHA,[Bo]:r.CONSTANT_COLOR,[zo]:r.ONE_MINUS_CONSTANT_COLOR,[Ho]:r.CONSTANT_ALPHA,[Vo]:r.ONE_MINUS_CONSTANT_ALPHA};function Ze(C,te,W,q,ie,_e,We,$e,lt,Fe){if(C===ni){x===!0&&(oe(r.BLEND),x=!1);return}if(x===!1&&(he(r.BLEND),x=!0),C!==yo){if(C!==M||Fe!==F){if((d!==vi||E!==vi)&&(r.blendEquation(r.FUNC_ADD),d=vi,E=vi),Fe)switch(C){case Yi:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ba:r.blendFunc(r.ONE,r.ONE);break;case za:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ha:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}else switch(C){case Yi:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ba:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case za:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ha:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}u=null,b=null,y=null,B=null,R.set(0,0,0),w=0,M=C,F=Fe}return}ie=ie||te,_e=_e||W,We=We||q,(te!==d||ie!==E)&&(r.blendEquationSeparate(Ye[te],Ye[ie]),d=te,E=ie),(W!==u||q!==b||_e!==y||We!==B)&&(r.blendFuncSeparate(A[W],A[q],A[_e],A[We]),u=W,b=q,y=_e,B=We),($e.equals(R)===!1||lt!==w)&&(r.blendColor($e.r,$e.g,$e.b,lt),R.copy($e),w=lt),M=C,F=!1}function ze(C,te){C.side===Xt?oe(r.CULL_FACE):he(r.CULL_FACE);let W=C.side===mt;te&&(W=!W),Ge(W),C.blending===Yi&&C.transparent===!1?Ze(ni):Ze(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),a.setFunc(C.depthFunc),a.setTest(C.depthTest),a.setMask(C.depthWrite),n.setMask(C.colorWrite);const q=C.stencilWrite;o.setTest(q),q&&(o.setMask(C.stencilWriteMask),o.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),o.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),Te(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?he(r.SAMPLE_ALPHA_TO_COVERAGE):oe(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(C){S!==C&&(C?r.frontFace(r.CW):r.frontFace(r.CCW),S=C)}function ge(C){C!==So?(he(r.CULL_FACE),C!==v&&(C===Fa?r.cullFace(r.BACK):C===Eo?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):oe(r.CULL_FACE),v=C}function Je(C){C!==P&&(Y&&r.lineWidth(C),P=C)}function Te(C,te,W){C?(he(r.POLYGON_OFFSET_FILL),(H!==te||z!==W)&&(r.polygonOffset(te,W),H=te,z=W)):oe(r.POLYGON_OFFSET_FILL)}function we(C){C?he(r.SCISSOR_TEST):oe(r.SCISSOR_TEST)}function T(C){C===void 0&&(C=r.TEXTURE0+X-1),V!==C&&(r.activeTexture(C),V=C)}function g(C,te,W){W===void 0&&(V===null?W=r.TEXTURE0+X-1:W=V);let q=ne[W];q===void 0&&(q={type:void 0,texture:void 0},ne[W]=q),(q.type!==C||q.texture!==te)&&(V!==W&&(r.activeTexture(W),V=W),r.bindTexture(C,te||Q[C]),q.type=C,q.texture=te)}function D(){const C=ne[V];C!==void 0&&C.type!==void 0&&(r.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function K(){try{r.compressedTexImage2D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function $(){try{r.compressedTexImage3D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function j(){try{r.texSubImage2D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ve(){try{r.texSubImage3D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ae(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ce(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function be(){try{r.texStorage2D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ee(){try{r.texStorage3D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ue(){try{r.texImage2D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Ne(){try{r.texImage3D.apply(r,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Ee(C){De.equals(C)===!1&&(r.scissor(C.x,C.y,C.z,C.w),De.copy(C))}function le(C){ke.equals(C)===!1&&(r.viewport(C.x,C.y,C.z,C.w),ke.copy(C))}function ye(C,te){let W=l.get(te);W===void 0&&(W=new WeakMap,l.set(te,W));let q=W.get(C);q===void 0&&(q=r.getUniformBlockIndex(te,C.name),W.set(C,q))}function Ue(C,te){const W=l.get(te).get(C);s.get(te)!==W&&(r.uniformBlockBinding(te,W,C.__bindingPointIndex),s.set(te,W))}function je(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),c={},V=null,ne={},h={},f=new WeakMap,p=[],m=null,x=!1,M=null,d=null,u=null,b=null,E=null,y=null,B=null,R=new Oe(0,0,0),w=0,F=!1,S=null,v=null,P=null,H=null,z=null,De.set(0,0,r.canvas.width,r.canvas.height),ke.set(0,0,r.canvas.width,r.canvas.height),n.reset(),a.reset(),o.reset()}return{buffers:{color:n,depth:a,stencil:o},enable:he,disable:oe,bindFramebuffer:Ae,drawBuffers:Le,useProgram:Ie,setBlending:Ze,setMaterial:ze,setFlipSided:Ge,setCullFace:ge,setLineWidth:Je,setPolygonOffset:Te,setScissorTest:we,activeTexture:T,bindTexture:g,unbindTexture:D,compressedTexImage2D:K,compressedTexImage3D:$,texImage2D:ue,texImage3D:Ne,updateUBOMapping:ye,uniformBlockBinding:Ue,texStorage2D:be,texStorage3D:ee,texSubImage2D:j,texSubImage3D:ve,compressedTexSubImage2D:ae,compressedTexSubImage3D:ce,scissor:Ee,viewport:le,reset:je}}function Us(r,e,t,i){const n=gp(i);switch(t){case ks:return r*e;case Ws:return r*e;case Xs:return r*e*2;case qs:return r*e/n.components*n.byteLength;case Sa:return r*e/n.components*n.byteLength;case js:return r*e*2/n.components*n.byteLength;case Ea:return r*e*2/n.components*n.byteLength;case Gs:return r*e*3/n.components*n.byteLength;case Pt:return r*e*4/n.components*n.byteLength;case Ta:return r*e*4/n.components*n.byteLength;case Vr:case kr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case Gr:case Wr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Wn:case qn:return Math.max(r,16)*Math.max(e,8)/4;case Gn:case Xn:return Math.max(r,8)*Math.max(e,8)/2;case jn:case Yn:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case Kn:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Zn:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Jn:return Math.floor((r+4)/5)*Math.floor((e+3)/4)*16;case $n:return Math.floor((r+4)/5)*Math.floor((e+4)/5)*16;case Qn:return Math.floor((r+5)/6)*Math.floor((e+4)/5)*16;case ea:return Math.floor((r+5)/6)*Math.floor((e+5)/6)*16;case ta:return Math.floor((r+7)/8)*Math.floor((e+4)/5)*16;case ia:return Math.floor((r+7)/8)*Math.floor((e+5)/6)*16;case ra:return Math.floor((r+7)/8)*Math.floor((e+7)/8)*16;case na:return Math.floor((r+9)/10)*Math.floor((e+4)/5)*16;case aa:return Math.floor((r+9)/10)*Math.floor((e+5)/6)*16;case sa:return Math.floor((r+9)/10)*Math.floor((e+7)/8)*16;case oa:return Math.floor((r+9)/10)*Math.floor((e+9)/10)*16;case la:return Math.floor((r+11)/12)*Math.floor((e+9)/10)*16;case ca:return Math.floor((r+11)/12)*Math.floor((e+11)/12)*16;case Xr:case ua:case ha:return Math.ceil(r/4)*Math.ceil(e/4)*16;case Ys:case da:return Math.ceil(r/4)*Math.ceil(e/4)*8;case pa:case fa:return Math.ceil(r/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function gp(r){switch(r){case Yt:case zs:return{byteLength:1,components:1};case cr:case Hs:case ur:return{byteLength:2,components:1};case xa:case Ma:return{byteLength:2,components:4};case Ti:case va:case qt:return{byteLength:4,components:1};case Vs:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function _p(r,e,t,i,n,a,o){const s=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Be,h=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(T,g){return m?new OffscreenCanvas(T,g):$r("canvas")}function M(T,g,D){let K=1;const $=we(T);if(($.width>D||$.height>D)&&(K=D/Math.max($.width,$.height)),K<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const j=Math.floor(K*$.width),ve=Math.floor(K*$.height);f===void 0&&(f=x(j,ve));const ae=g?x(j,ve):f;return ae.width=j,ae.height=ve,ae.getContext("2d").drawImage(T,0,0,j,ve),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+j+"x"+ve+")."),ae}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function d(T){return T.generateMipmaps&&T.minFilter!==yt&&T.minFilter!==Ct}function u(T){r.generateMipmap(T)}function b(T,g,D,K,$=!1){if(T!==null){if(r[T]!==void 0)return r[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let j=g;if(g===r.RED&&(D===r.FLOAT&&(j=r.R32F),D===r.HALF_FLOAT&&(j=r.R16F),D===r.UNSIGNED_BYTE&&(j=r.R8)),g===r.RED_INTEGER&&(D===r.UNSIGNED_BYTE&&(j=r.R8UI),D===r.UNSIGNED_SHORT&&(j=r.R16UI),D===r.UNSIGNED_INT&&(j=r.R32UI),D===r.BYTE&&(j=r.R8I),D===r.SHORT&&(j=r.R16I),D===r.INT&&(j=r.R32I)),g===r.RG&&(D===r.FLOAT&&(j=r.RG32F),D===r.HALF_FLOAT&&(j=r.RG16F),D===r.UNSIGNED_BYTE&&(j=r.RG8)),g===r.RG_INTEGER&&(D===r.UNSIGNED_BYTE&&(j=r.RG8UI),D===r.UNSIGNED_SHORT&&(j=r.RG16UI),D===r.UNSIGNED_INT&&(j=r.RG32UI),D===r.BYTE&&(j=r.RG8I),D===r.SHORT&&(j=r.RG16I),D===r.INT&&(j=r.RG32I)),g===r.RGB&&D===r.UNSIGNED_INT_5_9_9_9_REV&&(j=r.RGB9_E5),g===r.RGBA){const ve=$?Yr:Ve.getTransfer(K);D===r.FLOAT&&(j=r.RGBA32F),D===r.HALF_FLOAT&&(j=r.RGBA16F),D===r.UNSIGNED_BYTE&&(j=ve===Xe?r.SRGB8_ALPHA8:r.RGBA8),D===r.UNSIGNED_SHORT_4_4_4_4&&(j=r.RGBA4),D===r.UNSIGNED_SHORT_5_5_5_1&&(j=r.RGB5_A1)}return(j===r.R16F||j===r.R32F||j===r.RG16F||j===r.RG32F||j===r.RGBA16F||j===r.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function E(T,g){let D;return T?g===null||g===Ti||g===Qi?D=r.DEPTH24_STENCIL8:g===qt?D=r.DEPTH32F_STENCIL8:g===cr&&(D=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Ti||g===Qi?D=r.DEPTH_COMPONENT24:g===qt?D=r.DEPTH_COMPONENT32F:g===cr&&(D=r.DEPTH_COMPONENT16),D}function y(T,g){return d(T)===!0||T.isFramebufferTexture&&T.minFilter!==yt&&T.minFilter!==Ct?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function B(T){const g=T.target;g.removeEventListener("dispose",B),w(g),g.isVideoTexture&&h.delete(g)}function R(T){const g=T.target;g.removeEventListener("dispose",R),S(g)}function w(T){const g=i.get(T);if(g.__webglInit===void 0)return;const D=T.source,K=p.get(D);if(K){const $=K[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&F(T),Object.keys(K).length===0&&p.delete(D)}i.remove(T)}function F(T){const g=i.get(T);r.deleteTexture(g.__webglTexture);const D=T.source,K=p.get(D);delete K[g.__cacheKey],o.memory.textures--}function S(T){const g=i.get(T);if(T.depthTexture&&T.depthTexture.dispose(),T.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(g.__webglFramebuffer[K]))for(let $=0;$<g.__webglFramebuffer[K].length;$++)r.deleteFramebuffer(g.__webglFramebuffer[K][$]);else r.deleteFramebuffer(g.__webglFramebuffer[K]);g.__webglDepthbuffer&&r.deleteRenderbuffer(g.__webglDepthbuffer[K])}else{if(Array.isArray(g.__webglFramebuffer))for(let K=0;K<g.__webglFramebuffer.length;K++)r.deleteFramebuffer(g.__webglFramebuffer[K]);else r.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&r.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&r.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let K=0;K<g.__webglColorRenderbuffer.length;K++)g.__webglColorRenderbuffer[K]&&r.deleteRenderbuffer(g.__webglColorRenderbuffer[K]);g.__webglDepthRenderbuffer&&r.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const D=T.textures;for(let K=0,$=D.length;K<$;K++){const j=i.get(D[K]);j.__webglTexture&&(r.deleteTexture(j.__webglTexture),o.memory.textures--),i.remove(D[K])}i.remove(T)}let v=0;function P(){v=0}function H(){const T=v;return T>=n.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+n.maxTextures),v+=1,T}function z(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function X(T,g){const D=i.get(T);if(T.isVideoTexture&&Je(T),T.isRenderTargetTexture===!1&&T.version>0&&D.__version!==T.version){const K=T.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ke(D,T,g);return}}t.bindTexture(r.TEXTURE_2D,D.__webglTexture,r.TEXTURE0+g)}function Y(T,g){const D=i.get(T);if(T.version>0&&D.__version!==T.version){ke(D,T,g);return}t.bindTexture(r.TEXTURE_2D_ARRAY,D.__webglTexture,r.TEXTURE0+g)}function k(T,g){const D=i.get(T);if(T.version>0&&D.__version!==T.version){ke(D,T,g);return}t.bindTexture(r.TEXTURE_3D,D.__webglTexture,r.TEXTURE0+g)}function Z(T,g){const D=i.get(T);if(T.version>0&&D.__version!==T.version){G(D,T,g);return}t.bindTexture(r.TEXTURE_CUBE_MAP,D.__webglTexture,r.TEXTURE0+g)}const V={[Vn]:r.REPEAT,[Mi]:r.CLAMP_TO_EDGE,[kn]:r.MIRRORED_REPEAT},ne={[yt]:r.NEAREST,[nl]:r.NEAREST_MIPMAP_NEAREST,[vr]:r.NEAREST_MIPMAP_LINEAR,[Ct]:r.LINEAR,[cn]:r.LINEAR_MIPMAP_NEAREST,[Si]:r.LINEAR_MIPMAP_LINEAR},me={[cl]:r.NEVER,[ml]:r.ALWAYS,[ul]:r.LESS,[Ks]:r.LEQUAL,[hl]:r.EQUAL,[fl]:r.GEQUAL,[dl]:r.GREATER,[pl]:r.NOTEQUAL};function Me(T,g){if(g.type===qt&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Ct||g.magFilter===cn||g.magFilter===vr||g.magFilter===Si||g.minFilter===Ct||g.minFilter===cn||g.minFilter===vr||g.minFilter===Si)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(T,r.TEXTURE_WRAP_S,V[g.wrapS]),r.texParameteri(T,r.TEXTURE_WRAP_T,V[g.wrapT]),(T===r.TEXTURE_3D||T===r.TEXTURE_2D_ARRAY)&&r.texParameteri(T,r.TEXTURE_WRAP_R,V[g.wrapR]),r.texParameteri(T,r.TEXTURE_MAG_FILTER,ne[g.magFilter]),r.texParameteri(T,r.TEXTURE_MIN_FILTER,ne[g.minFilter]),g.compareFunction&&(r.texParameteri(T,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(T,r.TEXTURE_COMPARE_FUNC,me[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===yt||g.minFilter!==vr&&g.minFilter!==Si||g.type===qt&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const D=e.get("EXT_texture_filter_anisotropic");r.texParameterf(T,D.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,n.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function De(T,g){let D=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",B));const K=g.source;let $=p.get(K);$===void 0&&($={},p.set(K,$));const j=z(g);if(j!==T.__cacheKey){$[j]===void 0&&($[j]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,D=!0),$[j].usedTimes++;const ve=$[T.__cacheKey];ve!==void 0&&($[T.__cacheKey].usedTimes--,ve.usedTimes===0&&F(g)),T.__cacheKey=j,T.__webglTexture=$[j].texture}return D}function ke(T,g,D){let K=r.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(K=r.TEXTURE_2D_ARRAY),g.isData3DTexture&&(K=r.TEXTURE_3D);const $=De(T,g),j=g.source;t.bindTexture(K,T.__webglTexture,r.TEXTURE0+D);const ve=i.get(j);if(j.version!==ve.__version||$===!0){t.activeTexture(r.TEXTURE0+D);const ae=Ve.getPrimaries(Ve.workingColorSpace),ce=g.colorSpace===ri?null:Ve.getPrimaries(g.colorSpace),be=g.colorSpace===ri||ae===ce?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,g.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,g.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);let ee=M(g.image,!1,n.maxTextureSize);ee=Te(g,ee);const ue=a.convert(g.format,g.colorSpace),Ne=a.convert(g.type);let Ee=b(g.internalFormat,ue,Ne,g.colorSpace,g.isVideoTexture);Me(K,g);let le;const ye=g.mipmaps,Ue=g.isVideoTexture!==!0,je=ve.__version===void 0||$===!0,C=j.dataReady,te=y(g,ee);if(g.isDepthTexture)Ee=E(g.format===er,g.type),je&&(Ue?t.texStorage2D(r.TEXTURE_2D,1,Ee,ee.width,ee.height):t.texImage2D(r.TEXTURE_2D,0,Ee,ee.width,ee.height,0,ue,Ne,null));else if(g.isDataTexture)if(ye.length>0){Ue&&je&&t.texStorage2D(r.TEXTURE_2D,te,Ee,ye[0].width,ye[0].height);for(let W=0,q=ye.length;W<q;W++)le=ye[W],Ue?C&&t.texSubImage2D(r.TEXTURE_2D,W,0,0,le.width,le.height,ue,Ne,le.data):t.texImage2D(r.TEXTURE_2D,W,Ee,le.width,le.height,0,ue,Ne,le.data);g.generateMipmaps=!1}else Ue?(je&&t.texStorage2D(r.TEXTURE_2D,te,Ee,ee.width,ee.height),C&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ee.width,ee.height,ue,Ne,ee.data)):t.texImage2D(r.TEXTURE_2D,0,Ee,ee.width,ee.height,0,ue,Ne,ee.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ue&&je&&t.texStorage3D(r.TEXTURE_2D_ARRAY,te,Ee,ye[0].width,ye[0].height,ee.depth);for(let W=0,q=ye.length;W<q;W++)if(le=ye[W],g.format!==Pt)if(ue!==null)if(Ue){if(C)if(g.layerUpdates.size>0){const ie=Us(le.width,le.height,g.format,g.type);for(const _e of g.layerUpdates){const We=le.data.subarray(_e*ie/le.data.BYTES_PER_ELEMENT,(_e+1)*ie/le.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,W,0,0,_e,le.width,le.height,1,ue,We,0,0)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,W,0,0,0,le.width,le.height,ee.depth,ue,le.data,0,0)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,W,Ee,le.width,le.height,ee.depth,0,le.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?C&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,W,0,0,0,le.width,le.height,ee.depth,ue,Ne,le.data):t.texImage3D(r.TEXTURE_2D_ARRAY,W,Ee,le.width,le.height,ee.depth,0,ue,Ne,le.data)}else{Ue&&je&&t.texStorage2D(r.TEXTURE_2D,te,Ee,ye[0].width,ye[0].height);for(let W=0,q=ye.length;W<q;W++)le=ye[W],g.format!==Pt?ue!==null?Ue?C&&t.compressedTexSubImage2D(r.TEXTURE_2D,W,0,0,le.width,le.height,ue,le.data):t.compressedTexImage2D(r.TEXTURE_2D,W,Ee,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?C&&t.texSubImage2D(r.TEXTURE_2D,W,0,0,le.width,le.height,ue,Ne,le.data):t.texImage2D(r.TEXTURE_2D,W,Ee,le.width,le.height,0,ue,Ne,le.data)}else if(g.isDataArrayTexture)if(Ue){if(je&&t.texStorage3D(r.TEXTURE_2D_ARRAY,te,Ee,ee.width,ee.height,ee.depth),C)if(g.layerUpdates.size>0){const W=Us(ee.width,ee.height,g.format,g.type);for(const q of g.layerUpdates){const ie=ee.data.subarray(q*W/ee.data.BYTES_PER_ELEMENT,(q+1)*W/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,q,ee.width,ee.height,1,ue,Ne,ie)}g.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,ue,Ne,ee.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Ee,ee.width,ee.height,ee.depth,0,ue,Ne,ee.data);else if(g.isData3DTexture)Ue?(je&&t.texStorage3D(r.TEXTURE_3D,te,Ee,ee.width,ee.height,ee.depth),C&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,ue,Ne,ee.data)):t.texImage3D(r.TEXTURE_3D,0,Ee,ee.width,ee.height,ee.depth,0,ue,Ne,ee.data);else if(g.isFramebufferTexture){if(je)if(Ue)t.texStorage2D(r.TEXTURE_2D,te,Ee,ee.width,ee.height);else{let W=ee.width,q=ee.height;for(let ie=0;ie<te;ie++)t.texImage2D(r.TEXTURE_2D,ie,Ee,W,q,0,ue,Ne,null),W>>=1,q>>=1}}else if(ye.length>0){if(Ue&&je){const W=we(ye[0]);t.texStorage2D(r.TEXTURE_2D,te,Ee,W.width,W.height)}for(let W=0,q=ye.length;W<q;W++)le=ye[W],Ue?C&&t.texSubImage2D(r.TEXTURE_2D,W,0,0,ue,Ne,le):t.texImage2D(r.TEXTURE_2D,W,Ee,ue,Ne,le);g.generateMipmaps=!1}else if(Ue){if(je){const W=we(ee);t.texStorage2D(r.TEXTURE_2D,te,Ee,W.width,W.height)}C&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ue,Ne,ee)}else t.texImage2D(r.TEXTURE_2D,0,Ee,ue,Ne,ee);d(g)&&u(K),ve.__version=j.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function G(T,g,D){if(g.image.length!==6)return;const K=De(T,g),$=g.source;t.bindTexture(r.TEXTURE_CUBE_MAP,T.__webglTexture,r.TEXTURE0+D);const j=i.get($);if($.version!==j.__version||K===!0){t.activeTexture(r.TEXTURE0+D);const ve=Ve.getPrimaries(Ve.workingColorSpace),ae=g.colorSpace===ri?null:Ve.getPrimaries(g.colorSpace),ce=g.colorSpace===ri||ve===ae?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,g.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,g.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);const be=g.isCompressedTexture||g.image[0].isCompressedTexture,ee=g.image[0]&&g.image[0].isDataTexture,ue=[];for(let q=0;q<6;q++)!be&&!ee?ue[q]=M(g.image[q],!0,n.maxCubemapSize):ue[q]=ee?g.image[q].image:g.image[q],ue[q]=Te(g,ue[q]);const Ne=ue[0],Ee=a.convert(g.format,g.colorSpace),le=a.convert(g.type),ye=b(g.internalFormat,Ee,le,g.colorSpace),Ue=g.isVideoTexture!==!0,je=j.__version===void 0||K===!0,C=$.dataReady;let te=y(g,Ne);Me(r.TEXTURE_CUBE_MAP,g);let W;if(be){Ue&&je&&t.texStorage2D(r.TEXTURE_CUBE_MAP,te,ye,Ne.width,Ne.height);for(let q=0;q<6;q++){W=ue[q].mipmaps;for(let ie=0;ie<W.length;ie++){const _e=W[ie];g.format!==Pt?Ee!==null?Ue?C&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie,0,0,_e.width,_e.height,Ee,_e.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie,ye,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ue?C&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie,0,0,_e.width,_e.height,Ee,le,_e.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie,ye,_e.width,_e.height,0,Ee,le,_e.data)}}}else{if(W=g.mipmaps,Ue&&je){W.length>0&&te++;const q=we(ue[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,te,ye,q.width,q.height)}for(let q=0;q<6;q++)if(ee){Ue?C&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,ue[q].width,ue[q].height,Ee,le,ue[q].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,ye,ue[q].width,ue[q].height,0,Ee,le,ue[q].data);for(let ie=0;ie<W.length;ie++){const _e=W[ie].image[q].image;Ue?C&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie+1,0,0,_e.width,_e.height,Ee,le,_e.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie+1,ye,_e.width,_e.height,0,Ee,le,_e.data)}}else{Ue?C&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,Ee,le,ue[q]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,ye,Ee,le,ue[q]);for(let ie=0;ie<W.length;ie++){const _e=W[ie];Ue?C&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie+1,0,0,Ee,le,_e.image[q]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,ie+1,ye,Ee,le,_e.image[q])}}}d(g)&&u(r.TEXTURE_CUBE_MAP),j.__version=$.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function Q(T,g,D,K,$,j){const ve=a.convert(D.format,D.colorSpace),ae=a.convert(D.type),ce=b(D.internalFormat,ve,ae,D.colorSpace);if(!i.get(g).__hasExternalTextures){const be=Math.max(1,g.width>>j),ee=Math.max(1,g.height>>j);$===r.TEXTURE_3D||$===r.TEXTURE_2D_ARRAY?t.texImage3D($,j,ce,be,ee,g.depth,0,ve,ae,null):t.texImage2D($,j,ce,be,ee,0,ve,ae,null)}t.bindFramebuffer(r.FRAMEBUFFER,T),ge(g)?s.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,K,$,i.get(D).__webglTexture,0,Ge(g)):($===r.TEXTURE_2D||$>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,K,$,i.get(D).__webglTexture,j),t.bindFramebuffer(r.FRAMEBUFFER,null)}function he(T,g,D){if(r.bindRenderbuffer(r.RENDERBUFFER,T),g.depthBuffer){const K=g.depthTexture,$=K&&K.isDepthTexture?K.type:null,j=E(g.stencilBuffer,$),ve=g.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ae=Ge(g);ge(g)?s.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ae,j,g.width,g.height):D?r.renderbufferStorageMultisample(r.RENDERBUFFER,ae,j,g.width,g.height):r.renderbufferStorage(r.RENDERBUFFER,j,g.width,g.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,ve,r.RENDERBUFFER,T)}else{const K=g.textures;for(let $=0;$<K.length;$++){const j=K[$],ve=a.convert(j.format,j.colorSpace),ae=a.convert(j.type),ce=b(j.internalFormat,ve,ae,j.colorSpace),be=Ge(g);D&&ge(g)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,be,ce,g.width,g.height):ge(g)?s.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,be,ce,g.width,g.height):r.renderbufferStorage(r.RENDERBUFFER,ce,g.width,g.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function oe(T,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),X(g.depthTexture,0);const D=i.get(g.depthTexture).__webglTexture,K=Ge(g);if(g.depthTexture.format===Ki)ge(g)?s.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,D,0,K):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,D,0);else if(g.depthTexture.format===er)ge(g)?s.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,D,0,K):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,D,0);else throw new Error("Unknown depthTexture format")}function Ae(T){const g=i.get(T),D=T.isWebGLCubeRenderTarget===!0;if(T.depthTexture&&!g.__autoAllocateDepthBuffer){if(D)throw new Error("target.depthTexture not supported in Cube render targets");oe(g.__webglFramebuffer,T)}else if(D){g.__webglDepthbuffer=[];for(let K=0;K<6;K++)t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer[K]),g.__webglDepthbuffer[K]=r.createRenderbuffer(),he(g.__webglDepthbuffer[K],T,!1)}else t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=r.createRenderbuffer(),he(g.__webglDepthbuffer,T,!1);t.bindFramebuffer(r.FRAMEBUFFER,null)}function Le(T,g,D){const K=i.get(T);g!==void 0&&Q(K.__webglFramebuffer,T,T.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),D!==void 0&&Ae(T)}function Ie(T){const g=T.texture,D=i.get(T),K=i.get(g);T.addEventListener("dispose",R);const $=T.textures,j=T.isWebGLCubeRenderTarget===!0,ve=$.length>1;if(ve||(K.__webglTexture===void 0&&(K.__webglTexture=r.createTexture()),K.__version=g.version,o.memory.textures++),j){D.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer[ae]=[];for(let ce=0;ce<g.mipmaps.length;ce++)D.__webglFramebuffer[ae][ce]=r.createFramebuffer()}else D.__webglFramebuffer[ae]=r.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)D.__webglFramebuffer[ae]=r.createFramebuffer()}else D.__webglFramebuffer=r.createFramebuffer();if(ve)for(let ae=0,ce=$.length;ae<ce;ae++){const be=i.get($[ae]);be.__webglTexture===void 0&&(be.__webglTexture=r.createTexture(),o.memory.textures++)}if(T.samples>0&&ge(T)===!1){D.__webglMultisampledFramebuffer=r.createFramebuffer(),D.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let ae=0;ae<$.length;ae++){const ce=$[ae];D.__webglColorRenderbuffer[ae]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,D.__webglColorRenderbuffer[ae]);const be=a.convert(ce.format,ce.colorSpace),ee=a.convert(ce.type),ue=b(ce.internalFormat,be,ee,ce.colorSpace,T.isXRRenderTarget===!0),Ne=Ge(T);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ne,ue,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ae,r.RENDERBUFFER,D.__webglColorRenderbuffer[ae])}r.bindRenderbuffer(r.RENDERBUFFER,null),T.depthBuffer&&(D.__webglDepthRenderbuffer=r.createRenderbuffer(),he(D.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(j){t.bindTexture(r.TEXTURE_CUBE_MAP,K.__webglTexture),Me(r.TEXTURE_CUBE_MAP,g);for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)Q(D.__webglFramebuffer[ae][ce],T,g,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ce);else Q(D.__webglFramebuffer[ae],T,g,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);d(g)&&u(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ve){for(let ae=0,ce=$.length;ae<ce;ae++){const be=$[ae],ee=i.get(be);t.bindTexture(r.TEXTURE_2D,ee.__webglTexture),Me(r.TEXTURE_2D,be),Q(D.__webglFramebuffer,T,be,r.COLOR_ATTACHMENT0+ae,r.TEXTURE_2D,0),d(be)&&u(r.TEXTURE_2D)}t.unbindTexture()}else{let ae=r.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ae,K.__webglTexture),Me(ae,g),g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)Q(D.__webglFramebuffer[ce],T,g,r.COLOR_ATTACHMENT0,ae,ce);else Q(D.__webglFramebuffer,T,g,r.COLOR_ATTACHMENT0,ae,0);d(g)&&u(ae),t.unbindTexture()}T.depthBuffer&&Ae(T)}function Ye(T){const g=T.textures;for(let D=0,K=g.length;D<K;D++){const $=g[D];if(d($)){const j=T.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:r.TEXTURE_2D,ve=i.get($).__webglTexture;t.bindTexture(j,ve),u(j),t.unbindTexture()}}}const A=[],Ze=[];function ze(T){if(T.samples>0){if(ge(T)===!1){const g=T.textures,D=T.width,K=T.height;let $=r.COLOR_BUFFER_BIT;const j=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ve=i.get(T),ae=g.length>1;if(ae)for(let ce=0;ce<g.length;ce++)t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,ve.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglFramebuffer);for(let ce=0;ce<g.length;ce++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=r.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=r.STENCIL_BUFFER_BIT)),ae){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,ve.__webglColorRenderbuffer[ce]);const be=i.get(g[ce]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,be,0)}r.blitFramebuffer(0,0,D,K,0,0,D,K,$,r.NEAREST),l===!0&&(A.length=0,Ze.length=0,A.push(r.COLOR_ATTACHMENT0+ce),T.depthBuffer&&T.resolveDepthBuffer===!1&&(A.push(j),Ze.push(j),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ze)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,A))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ae)for(let ce=0;ce<g.length;ce++){t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.RENDERBUFFER,ve.__webglColorRenderbuffer[ce]);const be=i.get(g[ce]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.TEXTURE_2D,be,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[g])}}}function Ge(T){return Math.min(n.maxSamples,T.samples)}function ge(T){const g=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Je(T){const g=o.render.frame;h.get(T)!==g&&(h.set(T,g),T.update())}function Te(T,g){const D=T.colorSpace,K=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||D!==oi&&D!==ri&&(Ve.getTransfer(D)===Xe?(K!==Pt||$!==Yt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",D)),g}function we(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=P,this.setTexture2D=X,this.setTexture2DArray=Y,this.setTexture3D=k,this.setTextureCube=Z,this.rebindTextures=Le,this.setupRenderTarget=Ie,this.updateRenderTargetMipmap=Ye,this.updateMultisampleRenderTarget=ze,this.setupDepthRenderbuffer=Ae,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=ge}function vp(r,e){function t(i,n=ri){let a;const o=Ve.getTransfer(n);if(i===Yt)return r.UNSIGNED_BYTE;if(i===xa)return r.UNSIGNED_SHORT_4_4_4_4;if(i===Ma)return r.UNSIGNED_SHORT_5_5_5_1;if(i===Vs)return r.UNSIGNED_INT_5_9_9_9_REV;if(i===zs)return r.BYTE;if(i===Hs)return r.SHORT;if(i===cr)return r.UNSIGNED_SHORT;if(i===va)return r.INT;if(i===Ti)return r.UNSIGNED_INT;if(i===qt)return r.FLOAT;if(i===ur)return r.HALF_FLOAT;if(i===ks)return r.ALPHA;if(i===Gs)return r.RGB;if(i===Pt)return r.RGBA;if(i===Ws)return r.LUMINANCE;if(i===Xs)return r.LUMINANCE_ALPHA;if(i===Ki)return r.DEPTH_COMPONENT;if(i===er)return r.DEPTH_STENCIL;if(i===qs)return r.RED;if(i===Sa)return r.RED_INTEGER;if(i===js)return r.RG;if(i===Ea)return r.RG_INTEGER;if(i===Ta)return r.RGBA_INTEGER;if(i===Vr||i===kr||i===Gr||i===Wr)if(o===Xe)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===Vr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===kr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Gr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Wr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===Vr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===kr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Gr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Wr)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Gn||i===Wn||i===Xn||i===qn)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Gn)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Wn)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Xn)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===qn)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===jn||i===Yn||i===Kn)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(i===jn||i===Yn)return o===Xe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Kn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Zn||i===Jn||i===$n||i===Qn||i===ea||i===ta||i===ia||i===ra||i===na||i===aa||i===sa||i===oa||i===la||i===ca)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Zn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Jn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===$n)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Qn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ea)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ta)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ia)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ra)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===na)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===aa)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===sa)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===oa)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===la)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ca)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Xr||i===ua||i===ha)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(i===Xr)return o===Xe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ua)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ha)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ys||i===da||i===pa||i===fa)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(i===Xr)return a.COMPRESSED_RED_RGTC1_EXT;if(i===da)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===pa)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===fa)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Qi?r.UNSIGNED_INT_24_8:r[i]!==void 0?r[i]:null}return{convert:t}}class xp extends Tt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Hr extends _t{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Mp={type:"move"};class On{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Hr,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Hr,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Hr,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let n=null,a=null,o=null;const s=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const M of e.hand.values()){const d=t.getJointPose(M,i),u=this._getHandJoint(c,M);d!==null&&(u.matrix.fromArray(d.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=d.radius),u.visible=d!==null}const h=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=h.position.distanceTo(f.position),m=.02,x=.005;c.inputState.pinching&&p>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(a=t.getPose(e.gripSpace,i),a!==null&&(l.matrix.fromArray(a.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,a.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(a.linearVelocity)):l.hasLinearVelocity=!1,a.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(a.angularVelocity)):l.hasAngularVelocity=!1));s!==null&&(n=t.getPose(e.targetRaySpace,i),n===null&&a!==null&&(n=a),n!==null&&(s.matrix.fromArray(n.transform.matrix),s.matrix.decompose(s.position,s.rotation,s.scale),s.matrixWorldNeedsUpdate=!0,n.linearVelocity?(s.hasLinearVelocity=!0,s.linearVelocity.copy(n.linearVelocity)):s.hasLinearVelocity=!1,n.angularVelocity?(s.hasAngularVelocity=!0,s.angularVelocity.copy(n.angularVelocity)):s.hasAngularVelocity=!1,this.dispatchEvent(Mp)))}return s!==null&&(s.visible=n!==null),l!==null&&(l.visible=a!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Hr;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const Sp=`
void main() {
